...
//	UIBarButtonItem *doneButtonItem = [[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(doneAction:)] autorelease];
    ...
    UIBarButtonItem *doneButtonItem = [[[UIBarButtonItem alloc] initWithTitle:@"Upload" style:UIBarButtonItemStyleDone target:self action:@selector(doneAction:)] autorelease];
...
-(void)updateTableWithPreparedPhotos {
    ...
    if ( row >= 0 )
    {
        NSIndexPath *index = [NSIndexPath indexPathForRow:row inSection:0]; // [NSIndexPath indexPathWithIndex:self.elcAssets.count];
...
-(void)preparePhotos {
	...
	[self performSelectorOnMainThread:@selector(updateTableWithPreparedPhotos) withObject:nil waitUntilDone:NO];
