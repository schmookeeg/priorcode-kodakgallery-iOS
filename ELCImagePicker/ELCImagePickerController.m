...
-(void)selectedAssets:(NSArray*)_assets {
	...
	for(ALAsset *asset in _assets) {
		...
		//[workingDictionary setObject:[UIImage imageWithCGImage:[asset thumbnail] scale:1.0 orientation:[[asset valueForProperty:@"ALAssetPropertyOrientation"] intValue]] forKey:@"UIImagePickerControllerThumbnailImage"];
